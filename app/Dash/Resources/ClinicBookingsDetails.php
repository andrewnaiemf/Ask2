...
class ClinicBookingsDetails extends Resource {

	/**
	 * define Model of resource
	 * @param Model Class
	 */
	public static $model = \App\Models\ClinicBooking::class ;
	...
	public static function customName() {
		return  __('dash.booking.clinic.bookingsDetails');
	}
	...
	public function fields() {
		return [
            ...
            belongsTo()->make(__('dash.booking.clinic.clinic'), 'clinic', Clinics::class),
            text()->make(__('dash.booking.clinic.doctor_name'),'doctor_name'),
            number()->make(__('dash.booking.clinic.cost'),'cost'),

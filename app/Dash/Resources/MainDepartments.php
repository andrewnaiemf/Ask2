...
class MainDepartments extends Resource
{
    /**
    ...
    {
        return __('dash.main_departments.main_departments');
    }
    ...
    public function fields()
    {
        return [
            ...
            text()->make(__('dash.main_departments.name_ar'), 'name_ar')->hideInIndex(),
            text()->make(__('dash.main_departments.name_en'), 'name_en')->hideInIndex(),
            text()->make(__('dash.main_departments.name_eu'), 'name_eu')->hideInIndex(),
            text()->make(__('dash.main_departments.name'), 'name')->onlyIndex(),
            image()

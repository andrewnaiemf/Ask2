...
class Suggestions extends Resource {
	 ...
	 */
	public static $group = 'Suggestions';
	...
	public static function customName() {
        return __('dash.suggestions.suggestions');
	}
	...
	public function fields() {
		return [
            ...
            text()->make(__('dash.suggestions.name'), 'name'),
            text()->make(__('dash.suggestions.email'), 'email'),
            text()->make(__('dash.suggestions.notes'), 'notes'),

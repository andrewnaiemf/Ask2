...
class BookingDetails extends Resource {

	/**
	 * define Model of resource
	 * @param Model Class
	 */
	public static $model = \App\Models\BookingDetails::class ;
	...
	public function fields() {
		return [
            ...
            text()->make(__('dash.booking.OtherServiceBookings.year') ,'year'),
            text()->make(__('dash.booking.OtherServiceBookings.month') ,'month'),
            text()->make(__('dash.booking.OtherServiceBookings.day') ,'day'),
            text()->make(__('dash.booking.OtherServiceBookings.time') ,'time'),
		];
	}
